...
/**
 * Love Tornado entity - visual effect for Love Breathing forms.
 *
 * Features:
 ...
 * - Synced across multiplayer via SpawnLoveTornadoPacket
 *
 * Default animation: "base"
 * Animation file: love_tornado.animation.json
 * Model file: love_tornado.geo.json
 */
public class LoveTornadoEntity extends Mob implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    // Synced data for animation name
    private static final EntityDataAccessor<String> DATA_ANIMATION =
        SynchedEntityData.defineId(LoveTornadoEntity.class, EntityDataSerializers.STRING);

    private int ticksAlive = 0;
    private int lifetime = 40; // Default 2 seconds (40 ticks)

    public LoveTornadoEntity(EntityType<? extends Mob> type, Level level) {
        super(type, level);
    ...
    /**
     * Create a love tornado slashes entity with full control over position, orientation, animation, and lifetime.
     *
     ...
     * @param animationName The animation to play (from love_tornado.animation.json)
     * @param lifetimeTicks How long the entity should exist (in ticks)
     * @return The created entity
     */
    public static LoveTornadoEntity create(Level level, Vec3 position, float yaw, float pitch,
                                                 String animationName, int lifetimeTicks) {
        LoveTornadoEntity entity = new LoveTornadoEntity(ModEntities.LOVE_TORNADO.get(), level);
    ...
    public void registerControllers(ControllerRegistrar controllers) {
        // Controller for love tornado animation
        // Animation file: love_tornado.animation.json
        // Default animation: "base"
        controllers.add(new AnimationController<>(this, "controller", 0, state -> {
            ...
            // Format: "kimetsunoyaibamultiplayer.love_tornado.<animation>"
            // Example: "kimetsunoyaibamultiplayer.love_tornado.love_fifth_form"
            String animationResourceName = "kimetsunoyaibamultiplayer.love_tornado." + animationName;
