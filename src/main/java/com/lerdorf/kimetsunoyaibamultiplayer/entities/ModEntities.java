...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<MotherEntity>> MOTHER =
        ENTITY_TYPES.register("mother",
            () -> EntityType.Builder.of(MotherEntity::new, MobCategory.MONSTER)
                .sized(0.6F, 1.95F)
                .clientTrackingRange(64)
                .updateInterval(2)
                .build("mother"));

    public static final RegistryObject<EntityType<MantisDemonEntity>> MANTIS_DEMON =
        ENTITY_TYPES.register("mantis_demon",
            () -> EntityType.Builder.of(MantisDemonEntity::new, MobCategory.MONSTER)
                .sized(0.6F, 1.95F)
