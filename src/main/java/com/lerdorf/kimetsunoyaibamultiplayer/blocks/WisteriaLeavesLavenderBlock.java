...
/**
 * Specialized wisteria leaves for lavender variant.
 * Features:
 * - Drops lavender/purple petal particles when there's air below
 * - Repels monsters (demons) with weakness and slowness effects
 */
public class WisteriaLeavesLavenderBlock extends LeavesBlock {

    public WisteriaLeavesLavenderBlock(Properties properties) {
        super(properties);
    }
