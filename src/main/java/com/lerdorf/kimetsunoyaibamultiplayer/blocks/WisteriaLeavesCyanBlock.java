...
/**
 * Specialized wisteria leaves for cyan variant.
 * Features:
 * - Drops cyan petal particles when there's air below
 * - Repels monsters (demons) with weakness and slowness effects
 */
public class WisteriaLeavesCyanBlock extends LeavesBlock {

    public WisteriaLeavesCyanBlock(Properties properties) {
        super(properties);
    }
