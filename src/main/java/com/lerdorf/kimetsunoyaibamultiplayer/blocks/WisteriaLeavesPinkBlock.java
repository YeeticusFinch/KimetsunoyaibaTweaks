...
/**
 * Specialized wisteria leaves for pink variant.
 * Features:
 * - Drops pink petal particles when there's air below
 * - Repels monsters (demons) with weakness and slowness effects
 */
public class WisteriaLeavesPinkBlock extends LeavesBlock {

    public WisteriaLeavesPinkBlock(Properties properties) {
        super(properties);
    }
