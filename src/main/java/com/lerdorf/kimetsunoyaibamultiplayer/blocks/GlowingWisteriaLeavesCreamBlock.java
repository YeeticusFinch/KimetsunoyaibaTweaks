...
/**
 * Specialized glowing wisteria leaves for cream variant.
 * Features:
 ...
 */
public class GlowingWisteriaLeavesCreamBlock extends LeavesBlock {

    public GlowingWisteriaLeavesCreamBlock(Properties properties) {
        super(properties);
    }
