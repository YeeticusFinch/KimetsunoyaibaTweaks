...
public enum CosmeticArmorMaterial implements ArmorMaterial {
    ...
    PURPLE_SLAYER_UNIFORM("purple_slayer_uniform", 25, new int[]{4, 8, 10, 0}, 0, SoundEvents.ARMOR_EQUIP_LEATHER, 2.0F, 0.0F, () -> Ingredient.EMPTY),
    LOW_ARMOR_SLAYER_UNIFORM_BOOTS("low_armor_slayer_uniform_boots", 25, new int[]{2, 6, 8, 0}, 0, SoundEvents.ARMOR_EQUIP_LEATHER, 2.0F, 0.0F, () -> Ingredient.EMPTY),
    ...
    MUICHIRO_HAKAMA("muichiro_hakama", 25, new int[]{0, 0, 10, 0}, 0, SoundEvents.ARMOR_EQUIP_LEATHER, 2.0F, 0.0F, () -> Ingredient.EMPTY);
