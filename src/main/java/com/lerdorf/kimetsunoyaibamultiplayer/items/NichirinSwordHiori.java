...
/**
 * Hiori's frost breathing sword (6 forms + 7th form: Golden Senses)
 */
public class NichirinSwordHiori extends BreathingSwordItem {
    private static final BreathingTechnique FROST_BREATHING_WITH_SEVENTH = FrostBreathingForms.createFrostBreathingWithSeventh();

    public NichirinSwordHiori(Properties properties) {
        super(properties);
    }
