...
/**
 * Server-to-Client packet for rendering raw horizontal slash models.
 * Allows server-side code (like breathing forms) to trigger client-side horizontal slash rendering.
 */
public class RawHorizontalSlashRenderPacket {
     ...
     */
    public RawHorizontalSlashRenderPacket(String modelKey, float vert, float arcRange, int duration,
     ...
     */
    public RawHorizontalSlashRenderPacket(FriendlyByteBuf buf) {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        ctx.enqueueWork(() -> {
            ...
            DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> {
                ...
                // Render the raw horizontal slash model on client
                BonePositionTracker.renderRawHorizontalSlash(
                    modelKey,
                    vert,
                    arcRange,
                    duration,
