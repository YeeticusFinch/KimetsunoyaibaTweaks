...
/**
 * Packet to spawn Love Sword Slashes entity on all clients.
 ...
 * - animationName (String): Animation to play from love_sword_slashes.animation.json
        ...
        try {
            ...
            if (com.lerdorf.kimetsunoyaibamultiplayer.Config.logDebug) {
                com.lerdorf.kimetsunoyaibamultiplayer.Log.debug(
                    "[SpawnLoveSwordSlashesPacket] Client spawned love sword slashes at " +
            ...
            System.err.println("[SpawnLoveSwordSlashesPacket] Failed to spawn love sword slashes: " + e.getMessage());
            e.printStackTrace();
        }
    }
}
