...
/**
 * Tree decorator that places Cream Wisteria Petals hanging from the bottom of leaves
 */
public class WisteriaPetalsCreamDecorator extends TreeDecorator {
    public static final Codec<WisteriaPetalsCreamDecorator> CODEC = Codec.unit(WisteriaPetalsCreamDecorator::new);

    public WisteriaPetalsCreamDecorator() {
    }

    @Override
    protected TreeDecoratorType<?> type() {
        return ModTreeDecorators.WISTERIA_PETALS_CREAM.get();
    }
