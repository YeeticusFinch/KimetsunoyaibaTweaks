...
/**
 * Tree decorator that places Cyan Wisteria Petals hanging from the bottom of leaves
 */
public class WisteriaPetalsCyanDecorator extends TreeDecorator {
    public static final Codec<WisteriaPetalsCyanDecorator> CODEC = Codec.unit(WisteriaPetalsCyanDecorator::new);

    public WisteriaPetalsCyanDecorator() {
    }

    @Override
    protected TreeDecoratorType<?> type() {
        return ModTreeDecorators.WISTERIA_PETALS_CYAN.get();
    }
